...
/**
 * jupyter-repl's renderers, so an inspection bundle renders with the same
 * fidelity as a REPL result. Optional: the built-in fallback covers html,
 * markdown and plain text on its own.
 */
